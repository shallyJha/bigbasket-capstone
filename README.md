...
TODO: one paragraph summary of the project, the business problem, and what this repo delivers.
...
TODO: document the exact command to run `generate_data.py` and what it produces.
